        ...
        <div className="container">
          <div className="grid grid-cols-4 gap-8 max-lg:grid-cols-2">
            <div className="flex items-center gap-3 max-lg:justify-center">
              <MdOutlineLocalShipping className="text-main w-14 h-14"></MdOutlineLocalShipping>
            ...
            <div className="flex items-center gap-3 max-lg:justify-center">
              <FaRegCreditCard className="text-main w-14 h-14"></FaRegCreditCard>
              <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3 max-lg:justify-center">
              <MdOutlineHeadphones className="text-main w-14 h-14"></MdOutlineHeadphones>
              <div className="flex flex-col">
            ...
            <div className="flex items-center gap-3 max-lg:justify-center">
              <RiExchangeBoxLine className="text-main w-14 h-14"></RiExchangeBoxLine>
              <div className="flex flex-col">
